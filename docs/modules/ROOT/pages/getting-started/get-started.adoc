...
To view your pipeline runs, go to the *Activity*, click *Pipeline runs*, and then select one of the hyperlinks in *Name*. 
...
To add other users to collaborate in your workspace, follow the instructions in xref:getting-started/roles_persmissions.adoc[Roles and permissions].
