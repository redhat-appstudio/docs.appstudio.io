...
*** xref:how-to-guides/configuring-builds/proc_java_dependencies.adoc[Configuring dependencies rebuild for Java apps in the CLI]
...
*** xref:how-to-guides/inspect-supply-chain-metadata/proc_inspect_sbom.adoc[Inspecting SBOMs]
*** xref:how-to-guides/inspect-supply-chain-metadata/proc_inspect-slsa-provenance.adoc[Downloading your SLSA provenance]
